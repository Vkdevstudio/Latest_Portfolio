...
export const DEFAULT_SEO = {
  ...
  description: `Full Stack Developer, Chennai. End-to-end ownership across React, Next.js, Node.js, and distributed systems. Open for full-time roles and freelance projects globally.`,
  url: BASE_URL,
  ...
  subjectOf: [
    {
      ...
      operatingSystem: 'Web',
      about: { '@type': 'SoftwareApplication', name: 'Film Production Management System', applicationCategory: 'BusinessApplication', operatingSystem: 'Web' },
    ...
    },
    {
      ...
      applicationCategory: 'BusinessApplication',
      operatingSystem: 'Web',
about: { '@type': 'SoftwareApplication', name: 'Multilingual CRM Landing Page', applicationCategory: 'BusinessApplication', operatingSystem: 'Web' },
    ...
    },
    {
      ...
      applicationCategory: 'BusinessApplication',
      operatingSystem: 'Web',
      about: { '@type': 'SoftwareApplication', name: 'Multi-tenant Business Directory Platform', applicationCategory: 'BusinessApplication', operatingSystem: 'Web' },
    ...
    },
    {
      ...
      applicationCategory: 'BusinessApplication',
      operatingSystem: 'Web',
      about: { '@type': 'SoftwareApplication', name: 'Marketing Automation and Design Integration Platform', applicationCategory: 'BusinessApplication', operatingSystem: 'Web' },
    ...
    },
    {
      ...
      operatingSystem: 'Web',
      about: { '@type': 'SoftwareApplication', name: 'Healthcare Appointment and Patient Management SaaS', applicationCategory: 'HealthApplication', operatingSystem: 'Web' },
    ...
    },
    {
      ...
      applicationCategory: 'HealthApplication',
      operatingSystem: 'Web',
      about: { '@type': 'SoftwareApplication', name: 'Multi-specialty Healthcare Appointment Dashboard', applicationCategory: 'HealthApplication', operatingSystem: 'Web' },
    ...
    },
    {
      ...
      applicationCategory: 'BusinessApplication',
      operatingSystem: 'Web',
about: { '@type': 'SoftwareApplication', name: 'Property and Tenant Management Platform', applicationCategory: 'BusinessApplication', operatingSystem: 'Web' },
    ...
    },
    {
      ...
      applicationCategory: 'HealthApplication',
      operatingSystem: 'Web',
about: { '@type': 'SoftwareApplication', name: 'Healthcare Website Template System with Patient Portal', applicationCategory: 'HealthApplication', operatingSystem: 'Web' },
    ...
    },
    {
      ...
      applicationCategory: 'BusinessApplication',
      operatingSystem: 'Web',
about: { '@type': 'SoftwareApplication', name: 'QR-based Field Sales Lead Capture and Management System', applicationCategory: 'BusinessApplication', operatingSystem: 'Web' },
