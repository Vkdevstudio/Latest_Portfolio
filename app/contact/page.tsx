          ...
          <motion.div variants={itemVariants} initial="hidden" animate="visible" className="space-y-8">
            ...
            <div className="space-y-3 pt-6 border-t border-white/10">
              ...
              <div className="space-y-2 text-sm">
                <a href="mailto:vk5241415@gmail.com" className="flex items-center gap-2 text-neutral-400 hover:text-emerald-400 transition">
                  <Mail className="w-4 h-4" /> vk5241415@gmail.com
                </a>
                <a href="https://linkedin.com/in/vinod-manimaran" target="_blank" className="flex items-center gap-2 text-neutral-400 hover:text-emerald-400 transition">
